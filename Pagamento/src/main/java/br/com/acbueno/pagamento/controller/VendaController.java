package br.com.acbueno.pagamento.controller;
...
import br.com.acbueno.pagamento.service.VendaService;
...
public class VendaController {
  ...
  @PostMapping(produces = {"application/json", "application/xml", "appliation/x-yml"}, consumes = {"application/json", "application/xml", "application/x-yml"})
